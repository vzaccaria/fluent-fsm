(function(){
  ...
  describe('FSM operation', function(){
    return describe('Simple sequence', function(empty){
      it('should run a simple transition', function(done){
        ...
        ft.addRules(rules);
        ft.unfold();
        return ft.runEvents('I', ['x'], function(){
      ...
      it('should run a simple sequence, return to start', function(done){
        ...
        ft.addRules(rules);
        ft.unfold();
        return ft.runEvents('I', ['x', 'x', 'y', 'y'], function(){
      ...
      it('should run a simple sequence, no return to start ', function(done){
        ...
        ft.addRules(rules);
        ft.unfold();
        return ft.runEvents('I', ['x', 'y', 'y'], function(){
          ft.getCurrentState().should.equal('S');
          return done();
        });
      });
      it('should not react to events that are not specified ', function(done){
        ...
        ft.addRules(rules);
        ft.unfold();
        return ft.runEvents('I', ['x', 'y', 'e', 'x', 'y'], function(){
          ft.getCurrentState().should.equal('I');
          return done();
        });
      });
      ...
      return it('trigger event functions', function(done){
        ...
        ft.addRules(rules);
        ft.unfold();
        return ft.runEvents('I', ['x', 'y', 'e', 'x'], function(){
