(function(){
  ...
  describe('FSM operation', function(){
    ...
    return describe('Event management', function(empty){
      ...
      it('should trigger the correct amount of event functions in the correct order', function(){
        var ft, count, rules;
        ft = null;
        ft = new fsmTester();
        ft.createFsm();
      ...
      return it('should trigger the correct amount of event functions (sync)', function(done){
        var ft, count, rules;
        ft = null;
        ft = new fsmTester();
        ft.createFsm();
